 ...
 * File: util.js
 * -------------
 * This file exports tiny pieces of the acm.util package.
 */
 ...
 * ---------------------
 * This class is used for reporting errors.
 */

var ErrorException = function(msg) {
   this.message = msg;
};

ErrorException.prototype.getMessage = function() {
   return this.message;
};
...
TokenScanner.prototype.verifyToken = function(expected) {
   var token = this.nextToken();
   if (token != expected) {
      throw new Error("Found \"" + token + "\" when expecting \""
                                 + expected + "\"");
   }
};
