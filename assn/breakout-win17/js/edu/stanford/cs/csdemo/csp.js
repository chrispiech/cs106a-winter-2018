/*
 * File: csp.js
 * Created on Sun May 03 23:23:36 PDT 2015 by java2js
 * --------------------------------------------------
...
var SVMClass = edu_stanford_cs_svm_core.SVMClass;
var SVMMethod = edu_stanford_cs_svm_core.SVMMethod;
var Vector = edu_stanford_cs_svm_core.Vector;
var SVMAndOperator = edu_stanford_cs_svm_operator.SVMAndOperator;
var SVMAssignmentOperator = edu_stanford_cs_svm_operator.SVMAssignmentOperator;
var SVMBracketOperator = edu_stanford_cs_svm_operator.SVMBracketOperator;
var SVMEqualOperator = edu_stanford_cs_svm_operator.SVMEqualOperator;
var SVMGreaterEqualOperator = edu_stanford_cs_svm_operator.SVMGreaterEqualOperator;
var SVMGreaterThanOperator = edu_stanford_cs_svm_operator.SVMGreaterThanOperator;
var SVMLessEqualOperator = edu_stanford_cs_svm_operator.SVMLessEqualOperator;
var SVMLessThanOperator = edu_stanford_cs_svm_operator.SVMLessThanOperator;
var SVMListOperator = edu_stanford_cs_svm_operator.SVMListOperator;
var SVMMinusOperator = edu_stanford_cs_svm_operator.SVMMinusOperator;
var SVMNotEqualOperator = edu_stanford_cs_svm_operator.SVMNotEqualOperator;
var SVMNotOperator = edu_stanford_cs_svm_operator.SVMNotOperator;
var SVMOrOperator = edu_stanford_cs_svm_operator.SVMOrOperator;
var SVMParenOperator = edu_stanford_cs_svm_operator.SVMParenOperator;
var SVMPercentOperator = edu_stanford_cs_svm_operator.SVMPercentOperator;
var SVMPlusOperator = edu_stanford_cs_svm_operator.SVMPlusOperator;
var SVMSlashOperator = edu_stanford_cs_svm_operator.SVMSlashOperator;
var SVMStarOperator = edu_stanford_cs_svm_operator.SVMStarOperator;
var SVMUnaryMinusOperator = edu_stanford_cs_svm_operator.SVMUnaryMinusOperator;
var SVMUnaryPlusOperator = edu_stanford_cs_svm_operator.SVMUnaryPlusOperator;
...
CSPCPU.prototype = 
   jslib.inheritPrototype(SVM, "CSPCPU extends SVM");
CSPCPU.prototype.constructor = CSPCPU;
CSPCPU.prototype.$class = 
   new Class("CSPCPU", CSPCPU);

CSPCPU.prototype.getParser = function() {
   return this.parser;
};
...
CSPParser.prototype = 
   jslib.inheritPrototype(SVMParser, "CSPParser extends SVMParser");
...
CSPParser.prototype.defineOperators = function() {
   ...
   this.defineOperator("(", new SVMParenOperator(), 0, 110, RIGHT);
   this.defineOperator("[", new SVMBracketOperator(), 0, 110, RIGHT);
   this.defineOperator("+", new SVMPlusOperator(), 100, 80, LEFT);
   this.defineOperator("-", new SVMMinusOperator(), 100, 80, LEFT);
   this.defineInfixOperator("*", new SVMStarOperator(), 90, LEFT);
   this.defineInfixOperator("/", new SVMSlashOperator(), 90, LEFT);
   this.defineInfixOperator("%", new SVMPercentOperator(), 90, LEFT);
   this.defineInfixOperator("<", new SVMLessThanOperator(), 60, LEFT);
   this.defineInfixOperator("<=", new SVMLessEqualOperator(), 60, LEFT);
   this.defineInfixOperator(">", new SVMGreaterThanOperator(), 60, LEFT);
   this.defineInfixOperator(">=", new SVMGreaterEqualOperator(), 60, LEFT);
   this.defineInfixOperator("=", new SVMEqualOperator(), 50, LEFT);
   this.defineInfixOperator("<>", new SVMNotEqualOperator(), 50, LEFT);
   this.definePrefixOperator("NOT", new SVMNotOperator(), 40);
   this.defineInfixOperator("AND", new SVMAndOperator(), 30, LEFT);
   this.defineInfixOperator("OR", new SVMOrOperator(), 20, LEFT);
   this.defineInfixOperator("<-", this.assignmentOperator, 10, RIGHT);
   this.definePrefixOperator("+x", new SVMUnaryPlusOperator(), 100);
   this.definePrefixOperator("-x", new SVMUnaryMinusOperator(), 100);
   this.definePrefixOperator("[...]", new SVMListOperator(), 100);
};
...
CSPParser.prototype.addBuiltinFunctions = function(cv) {
   this.defineBuiltinProcedure(cv, "display");
...
CSPParser.prototype.defineBuiltinProcedure = function(cv, name) {
   cv.defineLabel(name);
...
CSPParser.prototype.defineBuiltinFunction = function(cv, name) {
   cv.defineLabel(name);
   cv.addInstruction(SVMC.CALLM, cv.stringRef("CSPFunctionClass." + name));
   cv.addInstruction(SVMC.RETURN, 1);
};

var CSPAssignmentOperator = function() {
   SVMAssignmentOperator.call(this);
};

CSPAssignmentOperator.prototype =
   jslib.inheritPrototype(SVMAssignmentOperator, "CSPAssignmentOperator extends SVMAssignmentOperator");
...
var CSPBracketOperator = function() {
   SVMBracketOperator.call(this);
};

CSPBracketOperator.prototype =
   jslib.inheritPrototype(SVMBracketOperator, "CSPBracketOperator extends SVMBracketOperator");
...
ReturnStatement.prototype.compile = function(p, args, cv) {
   ...
   cv.addInstruction(SVMC.RETURN, args.length);
};
